...
import "../accounts/TabbedInterface.css";
...
export const TabbedInterface = () => {
  ...
  const tabContent1 = {
    London1: {
      heading: (
        <div className="tabContent1head">
          <h3>Let's Beat Anxiety</h3>
        </div> 
      ),
      text: (
        <div className="tabContent1text">
          <p>
    ...
    Tokyo1: {
      heading: (
        <div className="tabContent1head">
          <h3>
            <strong>Let's Beat Anxiety</strong>
          </h3>
        </div>
      ),
      text: (
        <div className="tabContent1text">
          ...
          <button class="ab" type="button">
            <Link to="/assesment"className="abc">Let's Try</Link>
          </button>
        </div>
      ),
  ...
  const tabContent2 = {
    London2: {
      ...
      buttonText: <Link to="/Tabbed" className="tabutt">Begin your journey</Link>,
    },
    Paris2: {
  ...
  return (
    <>
      <div className="Tabcon">
        <div class="her1">
          <table class="home1">
            <tr>
              <td>
                <div class="her-text1">
                  <p class="btext-21">Lets Beat Anxiety !</p>
                  <p class="btext-31">
                    <table>
                      <tr>
                        <td>
              ...
              <td>
                <img class="herimg21" src={pic1} alt="" />
              </td>
            </tr>
          </table>

          <button class="cta11" type="button">
            <Link to="/assesment"className="cta111">Begin Assesments</Link>
          </button>
          <img class="heroic13" src={pic12} alt="" />
        </div>
        <div>
          <img class="heroic14" src={pic13} alt="" />
          <p className="greencontain">Understanding Anxiety</p>
          <p className="greencontain1">
        ...
        {activeTab && (
          <div className="tabcontent1">
            <table>
              <tr>
                <td>
                  <p className="cardtxt3">{tabContent1[activeTab].heading}</p>
                  <p className="cardtxt4">{tabContent1[activeTab].text}</p>
        ...
        <div class="wave1">
          <img class="img91" src={pink} alt="girl icon" />
          <p class="cardtxt10">Begin your journey</p>
          <p class="cardtxt20">
        ...
        {activeTab1 && (
          <div className="tabcontent2">
            <table>
              <tr>
                <td>
                  <p className="cardtxt3">{tabContent2[activeTab1].heading}</p>
                  <p className="cardtxt4">{tabContent2[activeTab1].text}</p>
                ...
                <td>
                  <img className="crying122" src={cry} alt="crying boy image" />
                </td>
              </tr>
            </table>
          </div>
